...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <!-- gnb 메뉴 리스트 -->
            <div class="collapse navbar-collapse gnb" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav gnb_ul">                    
                    <li class="gnb_li">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="row btn_wrap01">
                     <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center btn noConner">
                         구직신청서    
                     </div>    
                     <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3 text-center btn noConner">
                         구인신청서
                     </div>    
                     <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center btn noConner">
                         매칭리스트
        ...
        <div class="container-fluid">
            <div class="row">
               <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 noPadding listWrap">
                   <div class="list_title">검색결과 500개</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <p class="circle conner50">
                  <a href="#">구글플레이, 앱스토어에서 일방을 검색하세요</a>
                </p>
                ...
                for (var k = 0; k < btns.length; k++) {
                    if(i==k){
                       $(this).addClass("under_line");
                        ...
                        btns.eq(i).removeClass("under_line");
                    }    
                }
            });
            
        });   
       // api 등록 도메인 바꾸기(test버전)
